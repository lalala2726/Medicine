...
public class ImageParserController extends BaseController {
    ...
    public AjaxResult<MedicineInfoDto> medicineInfo(@RequestBody ParserMedicineInfoRequest request) {
        MedicineInfoDto medicineInfoDto = imageParserService.parserMedicineInfo(request);
