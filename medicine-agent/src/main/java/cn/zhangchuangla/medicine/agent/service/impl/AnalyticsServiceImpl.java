...
public class AnalyticsServiceImpl implements AnalyticsService {
    ...
    public List<cn.zhangchuangla.medicine.model.vo.analytics.StatusDistribution> orderStatusDistribution() {
        ...
        Map<String, OrderStatusEnum> statusMap = Stream.of(OrderStatusEnum.values())
                .collect(Collectors.toMap(OrderStatusEnum::getType, item -> item));
        list.forEach(item -> {
            OrderStatusEnum statusEnum = statusMap.get(item.getStatus());
    ...
    public List<PaymentDistribution> paymentDistribution() {
        ...
        Map<String, PayTypeEnum> payTypeMap = Stream.of(PayTypeEnum.values())
