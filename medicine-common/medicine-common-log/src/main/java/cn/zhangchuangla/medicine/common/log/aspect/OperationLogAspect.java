package cn.zhangchuangla.medicine.common.log.aspect;
...
import cn.zhangchuangla.medicine.common.log.support.OperationLogUtils;
...
public class OperationLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, OperationLog operationLog) throws Throwable {
        ...
        try {
            ...
            try {
                OperationLog resolved = resolveOperationLog(joinPoint, operationLog);
    ...
    private OperationLog resolveOperationLog(ProceedingJoinPoint joinPoint, OperationLog operationLog) {
