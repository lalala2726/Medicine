...
/**
 * 外科专家追问节点（Surgery Inquiry）
 * <p>
 * 负责：根据摘要生成外科处置相关追问要点，并累加追问轮次，补充到摘要中供后续诊断使用。
 */
@Component
@RequiredArgsConstructor
@Slf4j
public class SurgeryInquiryNodeAction implements NodeAction {

    private static final String PROMPT = DiagnosisWorkflowPrompt.SURGERY_INQUIRY_PROMPT;
    private final ChatClient chatClient;

    @Override
    public Map<String, Object> apply(OverAllState state) {
        log.info("【工作流】进入节点：{}", WorkflowStateKeys.NODE_SURGERY_INQUIRY);
