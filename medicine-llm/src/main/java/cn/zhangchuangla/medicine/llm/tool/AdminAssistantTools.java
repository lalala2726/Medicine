...
public class AdminAssistantTools {
    ...
    public long totalUsers() {
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在统计用户总数");
        long count = requireProvider().totalUserCount();
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "用户总数统计完毕");
        return count;
    }
    ...
    public OrderSnapshotTool orderByOrderNo(
        ...
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在查询订单信息");
        ...
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "订单信息查询完毕");
    ...
    public List<OrderSnapshotTool> latestOrders(
        ...
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在查询最新订单列表");
        List<OrderSnapshotTool> orders = requireProvider().latestOrders(safeLimit);
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "最新订单列表查询完毕");
        return orders;
    }
    ...
    public OrderOverviewSnapshotTool orderOverview() {
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在获取订单看板数据");
        OrderOverviewSnapshotTool overview = requireProvider().orderOverview();
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "订单看板数据获取完毕");
        return overview;
    }
    ...
    public RefundOverviewSnapshotTool refundOverview(
        ...
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在获取售后退款概况");
        RefundOverviewSnapshotTool overview = requireProvider().refundOverview(safeLimit);
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "售后退款概况获取完毕");
        return overview;
    }
    ...
    public List<ProductSnapshot> searchProducts(
        ...
        int safeLimit = limit == null || limit <= 0 ? 10 : Math.min(limit, 50);
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在搜索商品");
        List<ProductSnapshot> products = requireProvider().searchProducts(keyword, safeLimit);
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "商品搜索完毕");
        return products;
    }
    ...
    public ProductSnapshot getProductById(@ToolParam(description = "商品ID") Long productId) {
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在查询商品详情");
        ProductSnapshot snapshot = requireProvider().findProductById(productId)
                .orElseThrow(() -> new IllegalArgumentException("未找到对应的商品"));
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "商品详情查询完毕");
        return snapshot;
    }
    ...
    public AnalyticsOverviewSnapshotTool analyticsOverview() {
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在获取运营大盘数据");
        AnalyticsOverviewSnapshotTool overview = requireProvider().analyticsOverview();
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "运营大盘数据获取完毕");
        return overview;
    }
    ...
    public List<OrderTrendPointSnapshotTool> orderTrend(
        ...
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在获取订单趋势数据");
        List<OrderTrendPointSnapshotTool> trend = requireProvider().orderTrend(safePeriod);
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "订单趋势数据获取完毕");
        return trend;
    }
    ...
    public List<StatusDistributionSnapshotTool> orderStatusDistribution() {
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在获取订单状态分布");
        List<StatusDistributionSnapshotTool> distribution = requireProvider().orderStatusDistribution();
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "订单状态分布获取完毕");
        return distribution;
    }
    ...
    public List<PaymentDistributionSnapshotTool> paymentDistribution() {
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在获取支付方式分布");
        List<PaymentDistributionSnapshotTool> distribution = requireProvider().paymentDistribution();
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "支付方式分布获取完毕");
        return distribution;
    }
    ...
    public List<HotProductRankSnapshotTool> hotProducts(
        ...
        int safeLimit = limit == null || limit <= 0 ? 10 : Math.min(limit, 50);
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在获取热销商品榜单");
        List<HotProductRankSnapshotTool> products = requireProvider().hotProducts(safeLimit);
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "热销商品榜单获取完毕");
        return products;
    }
    ...
    public List<ReturnRateStatSnapshotTool> productReturnRates(
            @ToolParam(description = "返回条数，默认10") Integer limit) {
        int safeLimit = limit == null || limit <= 0 ? 10 : Math.min(limit, 50);
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在获取高退货率商品排行");
        List<ReturnRateStatSnapshotTool> stats = requireProvider().productReturnRates(safeLimit);
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "高退货率商品排行获取完毕");
        return stats;
    }
    ...
    public List<ChartTemplateRegistry.ChartDescriptor> listSupportedCharts() {
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在获取支持的图表类型");
        List<ChartTemplateRegistry.ChartDescriptor> descriptors = ChartTemplateRegistry.descriptors();
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "支持的图表类型获取完毕");
        return descriptors;
    }
    ...
    public ChartTemplateRegistry.ChartSample getChartSample(
        ...
        messageInjector.callToolAction(EventType.TOOL_CALL_START, "正在获取图表配置模板");
        ChartTemplateRegistry.ChartSample sample = ChartTemplateRegistry.sampleByNameOrType(nameOrType)
                .orElseThrow(() -> new IllegalArgumentException("未找到对应的图表类型"));
        messageInjector.callToolAction(EventType.TOOL_CALL_END, "图表配置模板获取完毕");
        return sample;
    }
